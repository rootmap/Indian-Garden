...
class MenuItemController extends Controller
{
    ...
    public function create(){
        ...
        return view('admin.pages.menuitem.menuitem_create',['dataRow_Category'=>$tab_Category]);
    }
    ...
    public function edit(MenuItem $menuitem,$id=0)
    {
        ...
        $tab_Category=Category::all();     
        return view('admin.pages.menuitem.menuitem_edit',['dataRow_Category'=>$tab_Category,'dataRow'=>$tab,'edit'=>true]);  
    }
