      ...
      <div class="row">
         <div class="col-xs-12 hidden-xs col-sm-6">
            ...
            <ul class="fa-ul list-inline top-info level-one">
               <li><a class="tel-no" href="tel:{{ $setting[0]->phone }}"><i class="fa fa-phone"></i> {{ $setting[0]->phone }}</a></li>
            </ul>
         </div>
         ...
         <div class="col-xs-12 col-sm-6">
            ...
            <ul class="list-inline top-social level-one pull-right">
               ...
               <li class="location active"><a href="#" style="color: #c79c60 !important;">SV </a></li>
               <li class="location"><a href="#">ENG </a></li>
            </ul>
