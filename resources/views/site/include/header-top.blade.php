            ...
            <ul class="list-inline top-social level-one pull-right">
               ...
               <li class="flag-area">
                  <dl id="sample" class="dropdown">
                     <dt><a href="#"><span><img class="flag" src="{{ url('site/img/usa-flag.png') }}" alt="English" /></span></a></dt>
                     <dd>
                        <ul class="flags-align">
                           <li><a href="#"><img class="flag" src="{{ url('site/img/Sweden-Flag.png') }}" alt="Swedish" /></a></li>
                           <li><a href="#"><span><img class="flag" src="{{ url('site/img/usa-flag.png') }}" alt="English" /></span></a></li>
                        </ul>
                     </dd>
                  </dl>
               </li>
