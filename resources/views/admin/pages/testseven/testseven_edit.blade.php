    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{url('testseven/list')}}">Datatable </a></li>
              <li class="breadcrumb-item"><a href="{{url('testseven/create')}}">Create New </a></li>
      ...
      <div class="col-md-8 offset-2">
        ...
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title">Edit / Modify Test Seven</h3>

            <div class="card-tools">
              <ul class="pagination pagination-sm float-right">
                <li class="page-item">
                    <a class="page-link bg-primary" href="{{url('testseven/create')}}"> 
                        Create 
                        <i class="fas fa-plus"></i>
                    </a>
                </li>
                <li class="page-item">
                    <a class="page-link bg-primary" href="{{url('testseven/list')}}"> 
                        Data 
                        <i class="fas fa-table"></i>
                    </a>
                </li>
                <li class="page-item">
                  <a class="page-link  bg-primary" target="_blank" href="{{url('testseven/export/pdf')}}">
                    <i class="fas fa-file-pdf" data-toggle="tooltip" data-html="true"title="Pdf"></i>
                  </a>
                </li>
                <li class="page-item">
                  <a class="page-link  bg-primary" target="_blank" href="{{url('testseven/export/excel')}}">
          ...
          <!-- /.card-header -->
          <!-- form start -->
          <form action="{{url('testseven/update/'.$dataRow->id)}}" method="post" enctype="multipart/form-data">
          {{csrf_field()}}
        ...
        <option value="">Please select</option>
            ...
            value="Inactive">Inactive</option>
                            ...
                            <div class="col-md-6">
                                @if(isset($dataRow->logo))
                                    @if(!empty($dataRow->logo))
                                        <img class="img-thumbnail" src="{{url('upload/testseven/'.$dataRow->logo)}}" width="150">
                                    @endif
                                @endif
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <a href="{{url('upload/testseven/'.$dataRow->download_files)}}" class="btn btn-primary">
            ...
            <div class="card-footer">
              ...
              <a class="btn btn-danger" href="{{url('testseven/edit/'.$dataRow->id)}}">
