...
@section("title","Create New Test Six")
@section("content")
    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{url('testsix/list')}}">Test Six Data</a></li>
              <li class="breadcrumb-item active">Create New Test Six</li>
            </ol>
      </div>
    </div>
    <div class="row">
      ...
      <div class="col-md-8 offset-2">
        ...
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title">Create New Test Six</h3>

            <div class="card-tools">
              <ul class="pagination pagination-sm float-right">
                <li class="page-item"><a class="page-link bg-primary" href="{{url('testsix/list')}}"> Data <i class="fas fa-table"></i></a></li>
                <li class="page-item">
          ...
          <!-- /.card-header -->
          <!-- form start -->
          <form action="{{url('testsix')}}" method="post" enctype="multipart/form-data">
          {{csrf_field()}}
        ...
        <option value="">Please select</option>
            ...
            <div class="card-footer">
              ...
              <a class="btn btn-danger" href="{{url('testsix/create')}}"><i class="far fa-times-circle"></i> Reset</a>
            </div>
          </form>
        </div>
        <!-- /.card -->
